...
<html>
  ...
  <head>
    ...
    <script src="returnValueCache.js"></script>

    <script src="ThirdPartyRestaurantApi.js"></script>
    <script src="ThirdPartyRestaurantApiAspects.js"></script>

    <script src="memoizedRestaurantApi.js"></script>
    <script src="memoizedRestaurantApi_tests.js"></script>
  </head>
